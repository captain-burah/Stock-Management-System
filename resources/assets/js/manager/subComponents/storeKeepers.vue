<template>
    <div>
        <div class="card">
            ...
            <h3 class="card-title">Stock Keepers</h3>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="addUser">Add New Store Keeper</h5>
                        <h5 class="modal-title" v-show="editMode" id="addUser">Update Store Keeper Info</h5>
    ...
    export default {
        ...
        methods: {
            ...
            updateUser(id){
                ...
                this.userForm.put('api/storeKeeper/'+this.userForm.id)
                .then(() => {
                    $('#addUser').modal('hide');
                    //success
                    swal.fire(
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            ...
                            this.userForm.delete('api/storeKeeper/'+id).then(() => {
                                swal.fire(
                                'Deleted!',
            ...
            loadUsers() {
                axios.get("api/storeKeeper").then(({data}) => (this.userAccounts = data.data));
            },
            createUser() {
                this.$Progress.start();
                this.userForm.post('api/storeKeeper')
                .then(()=>{
                    $('#addUser').modal('hide');
                    Toast.fire({
                        icon: 'success',
