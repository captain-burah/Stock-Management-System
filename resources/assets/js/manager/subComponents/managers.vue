            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="addManager">Add New Manager</h5>
                        <h5 class="modal-title" v-show="editMode" id="addManager">Update Manager Info</h5>
    ...
    export default {
        ...
        methods: {
            ...
            updateUser(id){
                ...
                this.userForm.put('api/manager/'+this.userForm.id)
                .then(() => {
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            ...
                            this.userForm.delete('api/manager/'+id).then(() => {
                                swal.fire(
                                'Deleted!',
            ...
            loadUsers() {
                axios.get("api/manager").then(({data}) => (this.userAccounts = data.data));
            },
            createUser() {
                this.$Progress.start();
                this.userForm.post('api/manager')
                .then(()=>{
                    $('#addManager').modal('hide');
                    Toast.fire({
                        icon: 'success',
