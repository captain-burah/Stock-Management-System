<template>
    <div>
        <div class="card">
            ...
            <h3 class="card-title">Cashiers</h3>
        ...
        <!-- Modal -->
        <div class="modal fade" id="addCashier" tabindex="-1" role="dialog" aria-labelledby="addCashier" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="addCashier">Add New Cashier</h5>
                        <h5 class="modal-title" v-show="editMode" id="addCashier">Update Cashier Info</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <!--  Password Name  -->
                        <div class="form-group">
                            <input v-model="userForm.password" type="password" name="password" placeholder="Password"
    ...
    export default {
        ...
        methods: {
            ...
            updateUser(id){
                ...
                this.userForm.put('api/cashier/'+this.userForm.id)
                .then(() => {
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            ...
                            this.userForm.delete('api/cashier/'+id).then(() => {
                                swal.fire(
                                'Deleted!',
            ...
            loadUsers() {
                axios.get("api/cashier").then(({data}) => (this.userAccounts = data.data));
            },
            createUser() {
                this.$Progress.start();
                this.userForm.post('api/cashier')
                .then(()=>{
                    $('#addCashier').modal('hide');
                    Toast.fire({
                        icon: 'success',
